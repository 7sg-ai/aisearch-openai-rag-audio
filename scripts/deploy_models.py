...
def get_service_info():
    ...
    # Load from azd
    endpoint = get_azd_env_value("AZURE_OPENAI_ENDPOINT") or os.environ.get(
        "AZURE_OPENAI_ENDPOINT", ""
    )
    resource_group = get_azd_env_value("AZURE_RESOURCE_GROUP") or os.environ.get(
...
def main():
    ...
    if success_count == 3:
        ...
        print(
            "Please check the errors above and deploy manually via Azure AI Foundry Portal if needed."
        )
